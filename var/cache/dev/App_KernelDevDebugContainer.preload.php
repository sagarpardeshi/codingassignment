...
require __DIR__.'/Container0VCFXws/App_KernelDevDebugContainer.php';
require __DIR__.'/Container0VCFXws/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/Container0VCFXws/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/Container0VCFXws/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/Container0VCFXws/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/Container0VCFXws/getValidator_ExpressionService.php';
require __DIR__.'/Container0VCFXws/getValidator_EmailService.php';
require __DIR__.'/Container0VCFXws/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/Container0VCFXws/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/Container0VCFXws/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/Container0VCFXws/getTwig_Form_RendererService.php';
require __DIR__.'/Container0VCFXws/getTranslation_Loader_YmlService.php';
require __DIR__.'/Container0VCFXws/getTranslation_Loader_XliffService.php';
require __DIR__.'/Container0VCFXws/getTranslation_Loader_ResService.php';
require __DIR__.'/Container0VCFXws/getTranslation_Loader_QtService.php';
require __DIR__.'/Container0VCFXws/getTranslation_Loader_PoService.php';
require __DIR__.'/Container0VCFXws/getTranslation_Loader_PhpService.php';
require __DIR__.'/Container0VCFXws/getTranslation_Loader_MoService.php';
require __DIR__.'/Container0VCFXws/getTranslation_Loader_JsonService.php';
require __DIR__.'/Container0VCFXws/getTranslation_Loader_IniService.php';
require __DIR__.'/Container0VCFXws/getTranslation_Loader_DatService.php';
require __DIR__.'/Container0VCFXws/getTranslation_Loader_CsvService.php';
require __DIR__.'/Container0VCFXws/getSession_Storage_NativeService.php';
require __DIR__.'/Container0VCFXws/getSessionService.php';
require __DIR__.'/Container0VCFXws/getServicesResetterService.php';
require __DIR__.'/Container0VCFXws/getSerializer_Mapping_CacheClassMetadataFactoryService.php';
require __DIR__.'/Container0VCFXws/getSerializerService.php';
require __DIR__.'/Container0VCFXws/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/Container0VCFXws/getSecurity_PasswordEncoderService.php';
require __DIR__.'/Container0VCFXws/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/Container0VCFXws/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/Container0VCFXws/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/Container0VCFXws/getSecurity_Csrf_TokenStorageService.php';
require __DIR__.'/Container0VCFXws/getSecurity_Csrf_TokenManagerService.php';
require __DIR__.'/Container0VCFXws/getSecurity_ContextListener_0Service.php';
require __DIR__.'/Container0VCFXws/getSecurity_ChannelListenerService.php';
require __DIR__.'/Container0VCFXws/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/Container0VCFXws/getSecurity_Authentication_Listener_Anonymous_MainService.php';
require __DIR__.'/Container0VCFXws/getSecurity_AccessListenerService.php';
require __DIR__.'/Container0VCFXws/getSecrets_VaultService.php';
require __DIR__.'/Container0VCFXws/getRouting_LoaderService.php';
require __DIR__.'/Container0VCFXws/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/Container0VCFXws/getPropertyAccessorService.php';
require __DIR__.'/Container0VCFXws/getMonolog_Logger_SecurityService.php';
require __DIR__.'/Container0VCFXws/getMimeTypesService.php';
require __DIR__.'/Container0VCFXws/getFragment_Renderer_InlineService.php';
require __DIR__.'/Container0VCFXws/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/Container0VCFXws/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/Container0VCFXws/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/Container0VCFXws/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/Container0VCFXws/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/Container0VCFXws/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/Container0VCFXws/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/Container0VCFXws/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/Container0VCFXws/getForm_Type_FormService.php';
require __DIR__.'/Container0VCFXws/getForm_Type_FileService.php';
require __DIR__.'/Container0VCFXws/getForm_Type_EntityService.php';
require __DIR__.'/Container0VCFXws/getForm_Type_ColorService.php';
require __DIR__.'/Container0VCFXws/getForm_Type_ChoiceService.php';
require __DIR__.'/Container0VCFXws/getForm_ServerParamsService.php';
require __DIR__.'/Container0VCFXws/getForm_RegistryService.php';
require __DIR__.'/Container0VCFXws/getForm_FactoryService.php';
require __DIR__.'/Container0VCFXws/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/Container0VCFXws/getFilesystemService.php';
require __DIR__.'/Container0VCFXws/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/Container0VCFXws/getErrorControllerService.php';
require __DIR__.'/Container0VCFXws/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/Container0VCFXws/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/Container0VCFXws/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/Container0VCFXws/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/Container0VCFXws/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/Container0VCFXws/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/Container0VCFXws/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/Container0VCFXws/getSecurityVoterService.php';
require __DIR__.'/Container0VCFXws/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/Container0VCFXws/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/Container0VCFXws/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/Container0VCFXws/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/Container0VCFXws/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/Container0VCFXws/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/Container0VCFXws/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/Container0VCFXws/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/Container0VCFXws/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/Container0VCFXws/getAdminContextResolverService.php';
require __DIR__.'/Container0VCFXws/getContainer_GetenvService.php';
require __DIR__.'/Container0VCFXws/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/Container0VCFXws/getContainer_EnvVarProcessorService.php';
require __DIR__.'/Container0VCFXws/getCacheClearerService.php';
require __DIR__.'/Container0VCFXws/getCache_SystemClearerService.php';
require __DIR__.'/Container0VCFXws/getCache_GlobalClearerService.php';
require __DIR__.'/Container0VCFXws/getCache_AppClearerService.php';
require __DIR__.'/Container0VCFXws/getAnnotations_CacheService.php';
require __DIR__.'/Container0VCFXws/getTemplateControllerService.php';
require __DIR__.'/Container0VCFXws/getRedirectControllerService.php';
require __DIR__.'/Container0VCFXws/getFieldProviderService.php';
require __DIR__.'/Container0VCFXws/getEntityUpdaterService.php';
require __DIR__.'/Container0VCFXws/getEntityRepositoryService.php';
require __DIR__.'/Container0VCFXws/getFiltersFormTypeService.php';
require __DIR__.'/Container0VCFXws/getCrudFormTypeService.php';
require __DIR__.'/Container0VCFXws/getEaCrudFormTypeExtensionService.php';
require __DIR__.'/Container0VCFXws/getSlugConfiguratorService.php';
require __DIR__.'/Container0VCFXws/getNumberConfiguratorService.php';
require __DIR__.'/Container0VCFXws/getMoneyConfiguratorService.php';
require __DIR__.'/Container0VCFXws/getDateTimeConfiguratorService.php';
require __DIR__.'/Container0VCFXws/getCommonPreConfiguratorService.php';
require __DIR__.'/Container0VCFXws/getCommonPostConfiguratorService.php';
require __DIR__.'/Container0VCFXws/getChoiceConfiguratorService.php';
require __DIR__.'/Container0VCFXws/getAssociationConfiguratorService.php';
require __DIR__.'/Container0VCFXws/getPaginatorFactoryService.php';
require __DIR__.'/Container0VCFXws/getFormFactoryService.php';
require __DIR__.'/Container0VCFXws/getFilterFactoryService.php';
require __DIR__.'/Container0VCFXws/getExceptionListenerService.php';
require __DIR__.'/Container0VCFXws/getCrudResponseListenerService.php';
require __DIR__.'/Container0VCFXws/getProviderRepositoryService.php';
require __DIR__.'/Container0VCFXws/getPlatformRepositoryService.php';
require __DIR__.'/Container0VCFXws/getBundleRepositoryService.php';
require __DIR__.'/Container0VCFXws/getHomeControllerService.php';
require __DIR__.'/Container0VCFXws/getProviderCrudControllerService.php';
require __DIR__.'/Container0VCFXws/getPlatformCrudControllerService.php';
require __DIR__.'/Container0VCFXws/getDashboardControllerService.php';
require __DIR__.'/Container0VCFXws/getBundleCrudControllerService.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_TcQaCCvService.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_QrcjTqqService.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_MjsCZrService.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_LaElj3Service.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_H8Ml21GService.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_FLx15phService.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_CoGsai3Service.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_Beq5mCoService.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_NRHRBMService.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_TpM2PZCService.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_PFJgvwMService.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_IRNYqg5Service.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_C9JCBPCService.php';
require __DIR__.'/Container0VCFXws/get_ServiceLocator_9oHZTibService.php';
...
$classes[] = 'App\Controller\Admin\BundleCrudController';
$classes[] = 'App\Controller\Admin\DashboardController';
$classes[] = 'App\Controller\Admin\PlatformCrudController';
$classes[] = 'App\Controller\Admin\ProviderCrudController';
$classes[] = 'App\Controller\Frontend\HomeController';
$classes[] = 'App\Repository\BundleRepository';
